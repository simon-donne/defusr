...
scene_seed = img_folder.split("_")[-1].rstrip('/')
...
def main():
    ...
    for view in range(nr_views):
        ...
        base_name = os.path.join(workpath,"depth/scene_%s_frame_%03d_depth" % (scene_seed, view + 1))
        ...
        cv2.imwrite(base_name + ".png", depth * 40)
