...
__global__ void MaximumReprojectionPooling_forward_kernel(
    float *input_bound,
    float *input_depth,
...
extern "C" void MaximumReprojectionPooling_updateOutput_gpu(
    ...
    THCudaTensor *input_mask)
{
    ...
    MaximumReprojectionPooling_forward_kernel<<<grid, block, 0, stream>>>(
        input_bound_p,
        input_depth_p,
        input_features_p,
        input_mask_p,
...
__global__ void MaximumReprojectionPooling_backward_kernel(
    float *input_bound,
    float *input_depth,
...
extern "C" void MaximumReprojectionPooling_updateGradInput_gpu(
    THCudaTensor *input_bound,
    THCudaTensor *input_depth,
    ...
    THCudaTensor *input_mask)
{
    ...
    cudaStream_t stream = THCState_getCurrentStream(state);
    MaximumReprojectionPooling_backward_kernel<<<grid, block, 0, stream>>>(
        input_bound_p,
        input_depth_p,
        dloss_input_bound_p,
        dloss_input_depth_p,
